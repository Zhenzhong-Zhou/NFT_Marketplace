        ...
        <div className="relative flex justify-center md:flex-col min-h-screen">
            ...
            >
                <div className="relative w-557 minmd:w-2/3 minmd:h-2/3 sm:w-full sm:h-300 h-557">
                    <Image
                      src={nft.image} objectFit="cover" className="rounded-xl shadow-lg" layout="fill"
                    />
                </div>
            </div>
                ...
                <div className="flex flex-row sm:flex-col mt-10">
                    {currentAccount === nft.seller.toLowerCase()
                        ? (
                            ...
                            ? (
                                <Button
                                  btnName="List on Marketplace" classStyles="mr-5 sm:mr-0 sm:mb-5 rounded-xl"
            ...
            {paymentModal && (
                <Modal
                  header="Check Out" body={<PaymentBodyCmp nft={nft} nftCurrency={nftCurrency} />}
                  footer={(
                        <div className="flex flex-row sm:flex-col">
                          <Button
                              btnName="Checkout" classStyles="mr-5 sm:mb-5 sm:mr-0 rounded-xl" handleClick={checkout}
                            />
                          <Button
                              btnName="Cancel" classStyles="rounded-xl" handleClick={() => setPaymentModal(false)}
                            />
                      </div>
                    )}
            ...
            {successModal && (
                <Modal
                  header="Payment Successful" body={(
                        ...
                        <div className="flexCenter flex-col">
                            <Button
                              btnName="Checkout It Out" classStyles="sm:mb-5 sm:mr-0 rounded-xl"
